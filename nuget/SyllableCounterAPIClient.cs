...
namespace APIVerve.API.SyllableCounter
{
    ...
    /// <summary>
    /// Client for the SyllableCounter API
    /// </summary>
    public class SyllableCounterAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/syllablecounter";
        ...
        {
            { "text", new ValidationRule { Type = "string", Required = true, MaxLength = 500 } }
        };
        ...
        public SyllableCounterAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SyllableCounterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SyllableCounterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SyllableCounterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SyllableCounterQueryOptions options)
        {
        ...
        public ResponseObj Execute(SyllableCounterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SyllableCounterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SyllableCounterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SyllableCounterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SyllableCounterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SyllableCounterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SyllableCounterQueryOptions options)
        {
