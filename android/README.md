...
```gradle
dependencies {
    implementation 'com.github.apiverve:syllablecounter-api:1.1.12'
}
```
...
```java
import com.apiverve.syllablecounter.SyllableCounterAPIClient;
import com.apiverve.syllablecounter.APIResponse;
import com.apiverve.syllablecounter.APIException;

// Initialize the client
SyllableCounterAPIClient client = new SyllableCounterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/syllablecounter](https://docs.apiverve.com/ref/syllablecounter)
...
- **Documentation:** [https://docs.apiverve.com/ref/syllablecounter](https://docs.apiverve.com/ref/syllablecounter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/syllablecounter-api/issues)
