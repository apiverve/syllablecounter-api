...
class TestSyllablecounterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = SyllablecounterAPIClient(self.api_key)

    @patch('apiverve_syllablecounter.apiClient.requests.get')
