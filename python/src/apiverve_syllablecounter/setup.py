...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/syllablecounter',
        'Source': 'https://github.com/apiverve/syllablecounter-api',
        'Bug Tracker': 'https://github.com/apiverve/syllablecounter-api/issues'
    },
    classifiers=[
