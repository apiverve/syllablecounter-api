# Syllable Counter API - Examples

This folder contains example code for using the Syllable Counter API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/syllablecounter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/syllablecounter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/syllablecounter](https://docs.apiverve.com/ref/syllablecounter)
