...
// Request contains the parameters for the Syllable Counter API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"text": {Type: "string", Required: true, MaxLength: intPtr(500)},
	}
...
// ResponseData contains the data returned by the Syllable Counter API.
